...
public class GuidFragment2 extends BaseFragment {
    ...
    protected void lazyLoad() {
        ...
        initAnmi1(mImageView1);
        initAnmi2(mImageView2);
    }
    ...
    protected void initView(View view) {
        mImageView1 = (ImageView) view.findViewById(R.id.iv1);
        mImageView2 = (ImageView) view.findViewById(R.id.iv2);
